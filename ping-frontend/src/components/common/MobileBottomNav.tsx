...
type MobileTab = "home" | "pings" | "moments" | "settings";
  ...
  return (
    <button
      ...
      className={`flex flex-col items-center gap-0.5 ${
        active ? "text-ping-orange font-bold" : "text-ping-text-light dark:text-ping-night-text-light font-medium"
      }`}
    >
      {icon}
